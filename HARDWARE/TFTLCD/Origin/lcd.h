...
//////////////////////////////////////////////////////////////////////////////////	 
//-----------------LCD端口定义---------------- 
#define	LCD_LED PDout(15)  		//LCD背光    		 PD2 	    
//LCD地址结构体
/*
typedef struct
{
...
*/
//使用NOR/SRAM的 Bank1.sector1,地址位HADDR[27,26]=00 A16作为数据命令区分线-> [27:24] = 1100 
//注意设置时存储器宽度为16位时，STM32内部会右移一位对齐! 	这里选择A16作为RS线：0001,1111,1111,1111,1110=0x1FFFE; 0x1FFFE>>1 = 0x0FFFF (A[16]=0);			    
